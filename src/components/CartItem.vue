  ...
  <div class="flex flex-col sm:grid sm:cart-grid sm:items-center py-5 border-b border-gray-200 last:border-b-0">
    ...
    <div class="flex items-center gap-4 mb-3 sm:mb-0 sm:pr-4">
      <div class="relative shrink-0">
        ...
        <button data-testid="btn-delete" @click="deleteCartItem(cartItem.product.id)">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex items-center">
          <button
            ...
            :disabled="cartItem.quantity <= 1" data-testid="btn-decrement" @click="updateCartItemQuantity(QuantityActions.decrement)">−</button>
          ...
          <button
            ...
            data-testid="btn-increment" @click="updateCartItemQuantity(QuantityActions.increment)">+</button>
        </div>
      </div>
