...
<template>
  <div class="font-lato">
    ...
    <div class="bg-card-bg rounded p-5 space-y-4">
      ...
      <div class="flex justify-between items-center border-b-2 border-slate-200 pb-2">
      ...
      <div class="flex justify-between items-center border-b-2 border-slate-200 pb-2 mt-10">
      ...
      <p v-if="!shipping && subTotal" class="text-xs text-center text-brand-pink -mt-2">
